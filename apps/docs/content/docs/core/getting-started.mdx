...
description: Set up @nilovon/bucketkit-core for server-side S3 uploads
---
...
- [Upload Policies](/docs/core/policies) - Configure validation rules
- [Custom Path Resolver](/docs/advanced/custom-path-resolver) - Organize your files
- [Error Handling](/docs/core/error-handling) - Handle upload errors gracefully
